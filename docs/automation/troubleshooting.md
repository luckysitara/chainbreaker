...
chainbreaker system heartbeat last
chainbreaker logs --follow
chainbreaker config get agents.defaults.heartbeat
chainbreaker channels status --probe
```
...
```bash
chainbreaker config get agents.defaults.heartbeat.activeHours
chainbreaker config get agents.defaults.heartbeat.activeHours.timezone
chainbreaker config get agents.defaults.userTimezone || echo "agents.defaults.userTimezone not set"
chainbreaker cron list
chainbreaker logs --follow
```
