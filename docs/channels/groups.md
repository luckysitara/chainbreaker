...
Chainbreaker treats group chats consistently across surfaces: Discord, iMessage, Matrix, Microsoft Teams, Signal, Slack, Telegram, WhatsApp, Zalo.

## Beginner intro (2 minutes)

Chainbreaker “lives” on your own messaging accounts. There is no separate WhatsApp bot user.
If **you** are in a group, Chainbreaker can see that group and respond there.
...
Translation: allowlisted senders can trigger Chainbreaker by mentioning it.
    ...
    list: [
      {
        id: "main",
        groupChat: {
          mentionPatterns: ["@chainbreaker", "chainbreaker", "\\+15555550123"],
          historyLimit: 50,
        },
      },
    ],
