...
- Install via CLI: `chainbreaker plugins install @chainbreaker/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `chainbreaker plugins install ./path/to/local/zalo-plugin`
   - From npm (if published): `chainbreaker plugins install @chainbreaker/zalo`
...
This page reflects current Chainbreaker behavior for **Zalo Bot Creator / Marketplace bots**.
...
- Approve via:
  - `chainbreaker pairing list zalo`
  - `chainbreaker pairing approve zalo <CODE>`
...
This table summarizes current **Zalo Bot Creator / Marketplace bot** behavior in Chainbreaker.
...
- Example: `chainbreaker message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `chainbreaker channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `chainbreaker logs --follow`
