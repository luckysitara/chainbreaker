---
summary: "Host Chainbreaker on a DigitalOcean Droplet"
read_when:
  - Setting up Chainbreaker on DigitalOcean
  - Looking for a simple paid VPS for Chainbreaker
title: "DigitalOcean"
---

# DigitalOcean

Run a persistent Chainbreaker Gateway on a DigitalOcean Droplet.
...
**Gateway will not start** -- Run `chainbreaker doctor --non-interactive` and check logs with `journalctl --user -u chainbreaker-gateway.service -n 50`.
