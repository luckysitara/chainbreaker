...
Chainbreaker standardizes timestamps so the model sees a **single reference time**.
...
unset, Chainbreaker resolves the **host timezone at runtime** (no config write).
