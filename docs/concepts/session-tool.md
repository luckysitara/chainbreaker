...
Chainbreaker gives agents tools to work across sessions -- listing conversations,
...
After the target responds, Chainbreaker can run a **reply-back loop** where the
