...
This page ties together how Chainbreaker handles inbound messages, sessions, queueing,
...
Channels can redeliver the same message after reconnects. Chainbreaker keeps a
...
Chainbreaker separates the **prompt body** from the **command body**:
...
Chainbreaker can expose or hide model reasoning:
