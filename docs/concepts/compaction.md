---
summary: "How Chainbreaker summarizes long conversations to stay within model limits"
read_when:
...
When a conversation approaches that limit, Chainbreaker **compacts** older messages
...
Chainbreaker compacts and retries).

<Info>
Before compacting, Chainbreaker automatically reminds the agent to save important
