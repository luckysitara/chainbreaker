---
summary: "Use Qianfan's unified API to access many models in Chainbreaker"
read_when:
...
3. Chainbreaker installed on your system
...
4. Copy the API key for use with Chainbreaker

## CLI setup

```bash
chainbreaker onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Chainbreaker Configuration](/gateway/configuration)
