---
summary: "Use NVIDIA's OpenAI-compatible API in Chainbreaker"
read_when:
  - You want to use NVIDIA models in Chainbreaker
...
chainbreaker onboard --auth-choice skip
chainbreaker models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
