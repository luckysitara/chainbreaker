---
summary: "Use Xiaomi MiMo models with Chainbreaker"
read_when:
  - You want Xiaomi MiMo models in Chainbreaker
...
Xiaomi MiMo is the API platform for **MiMo** models. Chainbreaker uses the Xiaomi
...
```bash
chainbreaker onboard --auth-choice xiaomi-api-key
# or non-interactive
chainbreaker onboard --auth-choice xiaomi-api-key --xiaomi-api-key "$XIAOMI_API_KEY"
```
