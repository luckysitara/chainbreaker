...
You can point Chainbreaker at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Chainbreaker
...
- [Anthropic provider](/providers/anthropic) - Native Chainbreaker integration with Claude setup-token or API keys
