---
summary: "Overview of Chainbreaker onboarding options and flows"
read_when:
...
Chainbreaker has two onboarding paths. Both configure auth, the Gateway, and
...
| **Command**    | `chainbreaker onboard`                 | Launch the app            |
...
CLI command docs: [`chainbreaker onboard`](/cli/onboard)

## macOS app onboarding

Open the Chainbreaker app. The first-run wizard walks you through the same steps
