---
summary: "First-run setup flow for Chainbreaker (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Chainbreaker">
...
<Step title="CLI">
  ...
  The app can install the global `chainbreaker` CLI via npm/pnpm so terminal
