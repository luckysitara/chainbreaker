...
- 生成的 Swift 模型：`apps/macos/Sources/ChainbreakerProtocol/GatewayModels.swift`
...
- https://raw.githubusercontent.com/chainbreaker/chainbreaker/main/dist/protocol.schema.json
