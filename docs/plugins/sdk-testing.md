...
summary: "Testing utilities and patterns for Chainbreaker plugins"
read_when:
...
Reference for test utilities, patterns, and lint enforcement for Chainbreaker
plugins.
...
**Import:** `chainbreaker/plugin-sdk/testing`
...
import { installCommonResolveTargetErrorCases } from "chainbreaker/plugin-sdk/testing";
...
import type { PluginRuntime } from "chainbreaker/plugin-sdk/runtime-store";
...
1. **No monolithic root imports** -- `chainbreaker/plugin-sdk` root barrel is rejected
...
Chainbreaker uses Vitest with V8 coverage thresholds. For plugin tests:
