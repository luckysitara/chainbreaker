...
Chainbreaker treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.chainbreaker/settings/voicewake.json`

Shape:

```json
{ "triggers": ["chainbreaker", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
