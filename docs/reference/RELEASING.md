...
Chainbreaker has three public release lanes:
...
- Run `RELEASE_TAG=vYYYY.M.D node --import tsx scripts/chainbreaker-npm-release-check.ts`
  (or the matching beta/correction tag) before approval
- After npm publish, run
  `node --import tsx scripts/chainbreaker-npm-postpublish-verify.ts YYYY.M.D`
...
- [`.github/workflows/chainbreaker-npm-release.yml`](https://github.com/chainbreaker/chainbreaker/blob/main/.github/workflows/chainbreaker-npm-release.yml)
- [`scripts/chainbreaker-npm-release-check.ts`](https://github.com/chainbreaker/chainbreaker/blob/main/scripts/chainbreaker-npm-release-check.ts)
- [`scripts/package-mac-dist.sh`](https://github.com/chainbreaker/chainbreaker/blob/main/scripts/package-mac-dist.sh)
- [`scripts/make_appcast.sh`](https://github.com/chainbreaker/chainbreaker/blob/main/scripts/make_appcast.sh)

Maintainers use the private release docs in
[`chainbreaker/maintainers/release/README.md`](https://github.com/chainbreaker/maintainers/blob/main/release/README.md)
