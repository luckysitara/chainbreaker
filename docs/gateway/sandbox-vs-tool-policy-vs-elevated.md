...
Chainbreaker has three related (but different) controls:
...
Use the inspector to see what Chainbreaker is _actually_ doing:
...
- `group:nodes`: `nodes`
- `group:chainbreaker`: all built-in Chainbreaker tools (excludes provider plugins)
