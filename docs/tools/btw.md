...
It is modeled after Claude Code's `/btw` behavior, but adapted to Chainbreaker's
...
If the main run is currently active, Chainbreaker snapshots the current message
