...
- Artifacts are stored under the temp subfolder: `$TMPDIR/chainbreaker-diffs`.
...
1. `browser.executablePath` in Chainbreaker config.
2. Environment variables:
   - `CHAINBREAKER_BROWSER_EXECUTABLE_PATH`
