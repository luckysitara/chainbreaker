...
export const es: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Editar ~/.chainbreaker/chainbreaker.json de forma segura.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "¿En el móvil? Copia la URL completa (incluyendo #token=...) desde chainbreaker dashboard --no-open en tu escritorio.",
    },
    insecure: {
