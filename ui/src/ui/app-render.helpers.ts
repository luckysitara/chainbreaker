...
import { ChainbreakerApp } from "./app.ts";
...
function resetChatStateForSessionSwitch(state: AppViewState, sessionKey: string) {
  ...
  (state as unknown as ChainbreakerApp).chatStreamStartedAt = null;
  state.chatRunId = null;
  (state as unknown as ChainbreakerApp).resetToolStream();
  (state as unknown as ChainbreakerApp).resetChatScroll();
  state.applySettings({
    ...state.settings,
    sessionKey,
  ...
  return html`
    <div class="chat-controls">
      <button
        ...
        @click=${async () => {
          const app = state as unknown as ChainbreakerApp;
