...
export function connectGateway(host: GatewayHost, options?: ConnectGatewayOptions) {
  ...
  const client = new GatewayBrowserClient({
    ...
    clientName: "chainbreaker-control-ui",
    clientVersion,
    mode: "webchat",
    ...
    onHello: (hello) => {
      ...
      void subscribeSessions(host as unknown as ChainbreakerApp);
      void loadAssistantIdentity(host as unknown as ChainbreakerApp);
      void loadAgents(host as unknown as ChainbreakerApp);
      void loadHealthState(host as unknown as ChainbreakerApp);
      void loadNodes(host as unknown as ChainbreakerApp, { quiet: true });
      void loadDevices(host as unknown as ChainbreakerApp, { quiet: true });
...
function handleTerminalChatEvent(
  ...
  if (runId && host.refreshSessionsAfterChat.has(runId)) {
    ...
    if (state === "final") {
      void loadSessions(host as unknown as ChainbreakerApp, {
  ...
  if (hadToolEvents && state === "final") {
    void loadChatHistory(host as unknown as ChainbreakerApp);
    return true;
  }
  return false;
}
...
function handleChatGatewayEvent(host: GatewayHost, payload: ChatEventPayload | undefined) {
  ...
  const state = handleChatEvent(host as unknown as ChainbreakerApp, payload);
