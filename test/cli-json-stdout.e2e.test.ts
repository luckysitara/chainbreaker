    ...
    await withTempHome(
      async (tempHome) => {
        ...
        const env = {
          ...
          CHAINBREAKER_TEST_FAST: "1",
        };
        delete env.CHAINBREAKER_HOME;
        delete env.CHAINBREAKER_STATE_DIR;
        delete env.CHAINBREAKER_CONFIG_PATH;
        delete env.VITEST;

        const entry = path.resolve(process.cwd(), "chainbreaker.mjs");
