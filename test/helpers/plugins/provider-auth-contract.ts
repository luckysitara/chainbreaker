...
type LoginOpenAICodexOAuth =
  (typeof import("chainbreaker/plugin-sdk/provider-auth-login"))["loginOpenAICodexOAuth"];
type GithubCopilotLoginCommand =
  (typeof import("chainbreaker/plugin-sdk/provider-auth-login"))["githubCopilotLoginCommand"];
...
type EnsureAuthProfileStore =
  typeof import("chainbreaker/plugin-sdk/provider-auth").ensureAuthProfileStore;
type ListProfilesForProvider =
  typeof import("chainbreaker/plugin-sdk/provider-auth").listProfilesForProvider;
...
vi.mock("chainbreaker/plugin-sdk/provider-auth-login", async (importOriginal) => {
  const actual =
    await importOriginal<typeof import("chainbreaker/plugin-sdk/provider-auth-login")>();
  return {
    ...actual,
...
vi.mock("chainbreaker/plugin-sdk/provider-auth", async (importOriginal) => {
  const actual = await importOriginal<typeof import("chainbreaker/plugin-sdk/provider-auth")>();
  return {
    ...actual,
