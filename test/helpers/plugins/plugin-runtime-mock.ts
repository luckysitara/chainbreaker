import { DEFAULT_MODEL, DEFAULT_PROVIDER } from "chainbreaker/plugin-sdk/agent-runtime";
import type { PluginRuntime } from "chainbreaker/plugin-sdk/testing";
import { removeAckReactionAfterReply, shouldAckReaction } from "chainbreaker/plugin-sdk/testing";
...
export function createPluginRuntimeMock(overrides: DeepPartial<PluginRuntime> = {}): PluginRuntime {
  const base: PluginRuntime = {
    ...
    state: {
      resolveStateDir: vi.fn(() => "/tmp/chainbreaker"),
    },
    modelAuth: {
