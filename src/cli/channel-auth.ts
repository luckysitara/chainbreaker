...
function isConfiguredAuthPlugin(plugin: ChannelPlugin, cfg: ChainbreakerConfig): boolean {
  const key = plugin.id;
...
function resolveConfiguredAuthChannelInput(cfg: ChainbreakerConfig, mode: ChannelAuthMode): string {
