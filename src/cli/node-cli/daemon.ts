...
function renderNodeServiceStartHints(): string[] {
  return buildPlatformServiceStartHints({
    installCommand: formatCliCommand("chainbreaker node install"),
    startCommand: formatCliCommand("chainbreaker node start"),
...
export async function runNodeDaemonStatus(opts: NodeDaemonStatusOptions = {}) {
  ...
  const hintEnv = {
    ...baseEnv,
    CHAINBREAKER_LOG_PREFIX: baseEnv.CHAINBREAKER_LOG_PREFIX ?? "node",
