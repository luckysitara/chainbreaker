...
vi.mock("../../config/config.js", () => ({
  getConfigPath: () => "/tmp/chainbreaker-test-missing-config.json",
...
describe("gateway run option collisions", () => {
  ...
  it.each([
    ...
    delete process.env.CHAINBREAKER_CLI_BACKEND_LOG_OUTPUT;
    ...
    expect(process.env.CHAINBREAKER_CLI_BACKEND_LOG_OUTPUT).toBe("1");
  });
