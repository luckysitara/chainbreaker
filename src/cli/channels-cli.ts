    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["chainbreaker channels list", "List configured channels and auth profiles."],
          ["chainbreaker channels status --probe", "Run channel status checks and probes."],
          [
            "chainbreaker channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["chainbreaker channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.chainbreaker.ai/cli/channels",
        )}\n`,
    );
