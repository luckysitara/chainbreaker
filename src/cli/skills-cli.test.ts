...
describe("skills-cli", () => {
  describe("formatSkillsList", () => {
    it("formats empty skills list", () => {
      ...
      expect(output).toContain("chainbreaker skills search");
    });
  ...
  describe("formatSkillInfo", () => {
    it("returns not found message for unknown skill", () => {
      ...
      expect(output).toContain("chainbreaker skills install");
    });
    ...
    it("shows API key storage guidance for the active config path", () => {
      ...
      expect(output).toContain("CHAINBREAKER_CONFIG_PATH");
      expect(output).toContain("default: ~/.chainbreaker/chainbreaker.json");
  ...
  describe("formatSkillsCheck", () => {
    it("shows summary of skill status", () => {
      ...
      expect(output).toContain("chainbreaker skills update");
    });
