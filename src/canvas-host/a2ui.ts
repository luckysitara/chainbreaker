...
export const A2UI_PATH = "/__chainbreaker__/a2ui";

export const CANVAS_HOST_PATH = "/__chainbreaker__/canvas";

export const CANVAS_WS_PATH = "/__chainbreaker__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.chainbreakerCanvasA2UIAction.postMessage(...)
  // - Android: window.chainbreakerCanvasA2UIAction.postMessage(...)
  const handlerNames = ["chainbreakerCanvasA2UIAction"];
  ...
  globalThis.Chainbreaker = globalThis.Chainbreaker ?? {};
  globalThis.Chainbreaker.postMessage = postToNode;
  globalThis.Chainbreaker.sendUserAction = sendUserAction;
  globalThis.chainbreakerPostMessage = postToNode;
  globalThis.chainbreakerSendUserAction = sendUserAction;
