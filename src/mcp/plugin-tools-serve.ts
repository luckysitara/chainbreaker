/**
 * Standalone MCP server that exposes Chainbreaker plugin-registered tools
...
function resolveTools(config: ChainbreakerConfig): AnyAgentTool[] {
...
export function createPluginToolsMcpServer(
  ...
  const server = new Server(
    { name: "chainbreaker-plugin-tools", version: VERSION },
    { capabilities: { tools: {} } },
  );
