...
const REQUIRE_PROFILE_KEYS = isTruthyEnvValue(process.env.CHAINBREAKER_LIVE_REQUIRE_PROFILE_KEYS);
...
function withPluginsEnabled(cfg: ChainbreakerConfig): ChainbreakerConfig {
  return {
    ...cfg,
    plugins: {
      ...cfg.plugins,
