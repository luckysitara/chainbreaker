...
export function listAuthProfileStorePaths(config: ChainbreakerConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: ChainbreakerConfig, stateDir: string): string[] {
