...
export const PLUGIN_MANIFEST_FILENAME = "chainbreaker.plugin.json";
...
// package.json "chainbreaker" metadata (used for setup/catalog)
...
export type ChainbreakerPackageStartup = {
  /**
...
export type ChainbreakerPackageManifest = {
  extensions?: string[];
  setupEntry?: string;
  channel?: PluginPackageChannel;
  install?: PluginPackageInstall;
  startup?: ChainbreakerPackageStartup;
};
...
): ChainbreakerPackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }
