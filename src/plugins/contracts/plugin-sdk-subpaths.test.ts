...
} from "chainbreaker/plugin-sdk/channel-contract";
import type {
  ChannelMessageActionContext as CoreChannelMessageActionContext,
  ChainbreakerPluginApi as CoreChainbreakerPluginApi,
  PluginRuntime as CorePluginRuntime,
} from "chainbreaker/plugin-sdk/core";
import * as providerEntrySdk from "chainbreaker/plugin-sdk/provider-entry";
...
import type {
  ...
  ChainbreakerPluginApi as SharedChainbreakerPluginApi,
...
import type { ChainbreakerPluginApi } from "../types.js";
...
describe("plugin-sdk subpath exports", () => {
  ...
  it("keeps shared plugin-sdk types aligned", () => {
    ...
    expectTypeOf<CoreChainbreakerPluginApi>().toMatchTypeOf<ChainbreakerPluginApi>();
    expectTypeOf<CorePluginRuntime>().toMatchTypeOf<PluginRuntime>();
    expectTypeOf<CoreChannelMessageActionContext>().toMatchTypeOf<ChannelMessageActionContext>();
    expectTypeOf<CoreChainbreakerPluginApi>().toMatchTypeOf<SharedChainbreakerPluginApi>();
  ...
  it("keeps runtime entry subpaths importable", async () => {
    const [
      ...
      importResolvedPluginSdkSubpath("chainbreaker/plugin-sdk/channel-actions"),
      importResolvedPluginSdkSubpath("chainbreaker/plugin-sdk/global-singleton"),
      importResolvedPluginSdkSubpath("chainbreaker/plugin-sdk/text-runtime"),
      importResolvedPluginSdkSubpath("chainbreaker/plugin-sdk/huggingface"),
