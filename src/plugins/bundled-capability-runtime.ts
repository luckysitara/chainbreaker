...
import type { ChainbreakerPluginDefinition, ChainbreakerPluginModule } from "./types.js";
...
function applyVitestCapabilityAliasOverrides(params: {
  ...
  const { ["chainbreaker/plugin-sdk"]: _ignoredRootAlias, ...scopedAliasMap } = params.aliasMap;
  return {
    ...scopedAliasMap,
...
function resolvePluginModuleExport(moduleExport: unknown): {
  ...
  if (resolved && typeof resolved === "object") {
    const definition = resolved as ChainbreakerPluginDefinition;
    return {
      definition,
