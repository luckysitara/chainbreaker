...
export const normalizePluginsConfig = (
  config?: ChainbreakerConfig["plugins"],
...
const hasExplicitMemorySlot = (plugins?: ChainbreakerConfig["plugins"]) =>
  Boolean(plugins?.slots && Object.prototype.hasOwnProperty.call(plugins.slots, "memory"));

const hasExplicitMemoryEntry = (plugins?: ChainbreakerConfig["plugins"]) =>
  Boolean(plugins?.entries && Object.prototype.hasOwnProperty.call(plugins.entries, "memory-core"));

export const hasExplicitPluginConfig = (plugins?: ChainbreakerConfig["plugins"]) => {
  if (!plugins) {
    return false;
  }
