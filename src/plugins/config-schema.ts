...
import type { PluginConfigUiHint, ChainbreakerPluginConfigSchema } from "./types.js";
...
type BuildPluginConfigSchemaOptions = {
  ...
  safeParse?: ChainbreakerPluginConfigSchema["safeParse"];
};
...
export function emptyPluginConfigSchema(): ChainbreakerPluginConfigSchema {
  return {
