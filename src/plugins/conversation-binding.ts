...
const APPROVALS_PATH = "~/.chainbreaker/plugin-binding-approvals.json";
...
const LEGACY_CODEX_PLUGIN_SESSION_PREFIXES = [
  "chainbreaker-app-server:thread:",
  "chainbreaker-codex-app-server:thread:",
] as const;
...
const PLUGIN_BINDING_PENDING_REQUESTS_KEY = Symbol.for("chainbreaker.pluginBindingPendingRequests");
...
const pluginBindingGlobalStateKey = Symbol.for("chainbreaker.plugins.binding.global-state");
