...
import type { ChainbreakerPluginCommandDefinition } from "./types.js";

export type RegisteredPluginCommand = ChainbreakerPluginCommandDefinition & {
  pluginId: string;
  pluginName?: string;
  pluginRoot?: string;
};
...
const PLUGIN_COMMAND_STATE_KEY = Symbol.for("chainbreaker.pluginCommandsState");
