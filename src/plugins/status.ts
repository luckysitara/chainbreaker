...
import { normalizeChainbreakerVersionBase } from "../config/version.js";
...
import { loadChainbreakerPlugins } from "./loader.js";
...
function resolveReportedPluginVersion(
  ...
  return (
    normalizeChainbreakerVersionBase(resolveCompatibilityHostVersion(env)) ??
    normalizeChainbreakerVersionBase(plugin.version) ??
    plugin.version
  );
}
