...
export function applyGoogleGeminiModelDefault(cfg: ChainbreakerConfig): {
...
export function applyOpenAIProviderConfig(cfg: ChainbreakerConfig): ChainbreakerConfig {
...
export function applyOpenAIConfig(cfg: ChainbreakerConfig): ChainbreakerConfig {
...
export function applyOpencodeGoModelDefault(cfg: ChainbreakerConfig): {
  next: ChainbreakerConfig;
  changed: boolean;
} {
...
export function applyOpencodeZenModelDefault(cfg: ChainbreakerConfig): {
  next: ChainbreakerConfig;
  changed: boolean;
} {
