...
describe("installPluginFromClawHub", () => {
  beforeEach(() => {
    ...
    installPluginFromArchiveMock.mockResolvedValue({
      ok: true,
      pluginId: "demo",
      targetDir: "/tmp/chainbreaker/plugins/demo",
      version: "2026.3.22",
    });
  });
  ...
  it.each([
    {
      ...
      expected: {
        ...
        error:
          'Plugin "demo" requires plugin API >=2026.3.22, but this Chainbreaker runtime exposes 2026.3.21.',
      },
    },
    {
      ...
      expected: {
        ...
        error: '"calendar" is a skill. Use "chainbreaker skills install calendar" instead.',
      },
    },
    {
