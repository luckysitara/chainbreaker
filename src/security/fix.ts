...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof ChainbreakerConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: ChainbreakerConfig; env: NodeJS.ProcessEnv }): {
  cfg: ChainbreakerConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
