...
let originalChainbreakerTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalChainbreakerTestConsole = process.env.CHAINBREAKER_TEST_CONSOLE;
  process.env.CHAINBREAKER_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalChainbreakerTestConsole === undefined) {
    delete process.env.CHAINBREAKER_TEST_CONSOLE;
  } else {
    process.env.CHAINBREAKER_TEST_CONSOLE = originalChainbreakerTestConsole;
  }
