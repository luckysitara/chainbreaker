...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("chainbreaker.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("chainbreaker.contextEngineRegistryState");
 ...
 */
export async function resolveContextEngine(config?: ChainbreakerConfig): Promise<ContextEngine> {
