...
export function applyMessageDefaults(cfg: ChainbreakerConfig): ChainbreakerConfig {
...
export function applyTalkApiKey(config: ChainbreakerConfig): ChainbreakerConfig {
...
export function applyTalkConfigNormalization(config: ChainbreakerConfig): ChainbreakerConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: ChainbreakerConfig): ChainbreakerConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: ChainbreakerConfig): ChainbreakerConfig {
...
export function applyLoggingDefaults(cfg: ChainbreakerConfig): ChainbreakerConfig {
...
export function applyContextPruningDefaults(cfg: ChainbreakerConfig): ChainbreakerConfig {
...
export function applyCompactionDefaults(cfg: ChainbreakerConfig): ChainbreakerConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
