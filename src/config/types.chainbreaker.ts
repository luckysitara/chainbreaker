...
export type ChainbreakerConfig = {
  meta?: {
    /** Last Chainbreaker version that wrote this config. */
  ...
  ui?: {
    /** Accent color for Chainbreaker UI chrome (hex). */
    seamColor?: string;
    assistant?: {
...
type BrandedConfigState<TState extends string> = ChainbreakerConfig & {
