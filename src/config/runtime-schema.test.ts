...
import type { ConfigFileSnapshot, ChainbreakerConfig } from "./types.js";

const mockLoadConfig = vi.hoisted(() => vi.fn<() => ChainbreakerConfig>());
...
function makeSnapshot(params: { valid: boolean; config?: ChainbreakerConfig }): ConfigFileSnapshot {
  return {
