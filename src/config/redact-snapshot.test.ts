...
import type { ConfigFileSnapshot } from "./types.chainbreaker.js";
...
describe("redactConfigSnapshot", () => {
  ...
  it("does not redact passwordFile path fields", () => {
    const snapshot = makeSnapshot({
      channels: {
        irc: {
          passwordFile: "/etc/chainbreaker/irc-password.txt",
          nickserv: {
            passwordFile: "/etc/chainbreaker/nickserv-password.txt",
    ...
    expect(irc.passwordFile).toBe("/etc/chainbreaker/irc-password.txt");
    expect(nickserv.passwordFile).toBe("/etc/chainbreaker/nickserv-password.txt");
