...
export function listConfiguredBindings(cfg: ChainbreakerConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listRouteBindings(cfg: ChainbreakerConfig): AgentRouteBinding[] {
  return listConfiguredBindings(cfg).filter(isRouteBinding);
}

export function listAcpBindings(cfg: ChainbreakerConfig): AgentAcpBinding[] {
