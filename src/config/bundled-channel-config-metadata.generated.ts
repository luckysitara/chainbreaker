...
export const GENERATED_BUNDLED_CHANNEL_CONFIG_METADATA = [
  ...
  },
  {
    ...
    uiHints: {
      "": {
        label: "IRC",
        help: "IRC channel provider configuration and compatibility settings for classic IRC transport workflows. Use this section when bridging legacy chat infrastructure into Chainbreaker.",
      },
      dmPolicy: {
        label: "IRC DM Policy",
  ...
  },
  {
    ...
    uiHints: {
      ...
      "execApprovals.approvers": {
        ...
        help: "Slack user IDs allowed to approve exec requests for this workspace account. Use Slack user IDs or user targets such as `U123`, `user:U123`, or `<@U123>`. If you leave this unset, Chainbreaker falls back to commands.ownerAllowFrom when possible.",
      },
  ...
  },
  {
    ...
    label: "Synology Chat",
    description: "Connect your Synology NAS Chat to Chainbreaker with full agent capabilities.",
    schema: {
      $schema: "http://json-schema.org/draft-07/schema#",
      type: "object",
      properties: {
