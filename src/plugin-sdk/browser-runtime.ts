...
export const DEFAULT_CHAINBREAKER_BROWSER_COLOR: FacadeModule["DEFAULT_CHAINBREAKER_BROWSER_COLOR"] =
  loadFacadeModule()["DEFAULT_CHAINBREAKER_BROWSER_COLOR"];
export const DEFAULT_CHAINBREAKER_BROWSER_PROFILE_NAME: FacadeModule["DEFAULT_CHAINBREAKER_BROWSER_PROFILE_NAME"] =
  loadFacadeModule()["DEFAULT_CHAINBREAKER_BROWSER_PROFILE_NAME"];
...
export type ChainbreakerPluginApi = FacadeEntry["types"]["ChainbreakerPluginApi"];
export type ChainbreakerPluginToolContext = FacadeEntry["types"]["ChainbreakerPluginToolContext"];
export type ChainbreakerPluginToolFactory = FacadeEntry["types"]["ChainbreakerPluginToolFactory"];
