...
export type { ChainbreakerConfig, ModelApi, ModelDefinitionConfig, ModelProviderConfig };
export {
...
export type ProviderOnboardPresetAppliers<TArgs extends unknown[]> = {
  applyProviderConfig: (cfg: ChainbreakerConfig, ...args: TArgs) => ChainbreakerConfig;
  applyConfig: (cfg: ChainbreakerConfig, ...args: TArgs) => ChainbreakerConfig;
};
...
>(params: {
  ...
  applyPreset: (cfg: ChainbreakerConfig, preset: TParams) => ChainbreakerConfig;
  primaryModelRef: string;
