...
import type { ChainbreakerPluginApi, ChainbreakerPluginConfigSchema } from "../plugins/types.js";
...
type DefineChannelPluginEntryOptions<TPlugin = ChannelPlugin> = {
  ...
  registerCliMetadata?: (api: ChainbreakerPluginApi) => void;
  registerFull?: (api: ChainbreakerPluginApi) => void;
};
...
type ChatChannelThreadingReplyModeOptions<TResolvedAccount> =
  ...
  | {
      scopedAccountReplyToMode: {
        resolveAccount: (cfg: ChainbreakerConfig, accountId?: string | null) => TResolvedAccount;
        resolveReplyToMode: (
