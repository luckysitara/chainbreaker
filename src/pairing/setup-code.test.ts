...
describe("pairing setup code", () => {
  ...
  beforeEach(() => {
    vi.stubEnv("CHAINBREAKER_GATEWAY_TOKEN", "");
    vi.stubEnv("CHAINBREAKER_GATEWAY_PASSWORD", "");
    vi.stubEnv("CHAINBREAKER_GATEWAY_PORT", "");
  });
  ...
  it.each([
    ...
    {
      name: "uses CHAINBREAKER_GATEWAY_PASSWORD without resolving configured password SecretRef",
      auth: {
        mode: "password",
  ...
  it.each([
    ...
    },
    {
      ...
      options: {
        env: {
          CHAINBREAKER_GATEWAY_TOKEN: "new-token",
        },
