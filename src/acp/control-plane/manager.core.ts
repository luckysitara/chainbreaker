...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: ChainbreakerConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: ChainbreakerConfig): AcpManagerObservabilitySnapshot {
  ...
  private resolveTurnTimeoutMs(params: { cfg: ChainbreakerConfig; meta: SessionAcpMeta }): number {
