...
export function isAcpEnabledByPolicy(cfg: ChainbreakerConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: ChainbreakerConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: ChainbreakerConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: ChainbreakerConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: ChainbreakerConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: ChainbreakerConfig, agentId: string): boolean {
