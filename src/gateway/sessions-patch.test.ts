...
const EMPTY_CFG = {} as ChainbreakerConfig;
...
async function applySubagentModelPatch(cfg: ChainbreakerConfig) {
...
function createAllowlistedAnthropicModelCfg(): ChainbreakerConfig {
  return {
    agents: {
      defaults: {
