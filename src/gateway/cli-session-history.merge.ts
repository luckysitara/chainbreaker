...
function resolveImportedExternalId(message: unknown): string | undefined {
  ...
  const meta =
    "__chainbreaker" in message &&
    (message as { __chainbreaker?: unknown }).__chainbreaker &&
    typeof (message as { __chainbreaker?: unknown }).__chainbreaker === "object"
      ? ((message as { __chainbreaker?: Record<string, unknown> }).__chainbreaker ?? {})
      : undefined;
