...
export function collectConfiguredModelPricingRefs(config: ChainbreakerConfig): ModelRef[] {
...
function scheduleRefresh(params: { config: ChainbreakerConfig; fetchImpl: typeof fetch }): void {
  clearRefreshTimer();
