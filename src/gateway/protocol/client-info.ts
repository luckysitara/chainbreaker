export const GATEWAY_CLIENT_IDS = {
  ...
  CONTROL_UI: "chainbreaker-control-ui",
  TUI: "chainbreaker-tui",
  WEBCHAT: "webchat",
  CLI: "cli",
  GATEWAY_CLIENT: "gateway-client",
  MACOS_APP: "chainbreaker-macos",
  IOS_APP: "chainbreaker-ios",
  ANDROID_APP: "chainbreaker-android",
  NODE_HOST: "node-host",
  TEST: "test",
  FINGERPRINT: "fingerprint",
  PROBE: "chainbreaker-probe",
} as const;
