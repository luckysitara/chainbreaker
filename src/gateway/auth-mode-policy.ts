...
export function hasAmbiguousGatewayAuthModeConfig(cfg: ChainbreakerConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: ChainbreakerConfig): void {
