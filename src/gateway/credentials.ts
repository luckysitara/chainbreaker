  ...
  constructor(path: string) {
    super(
      [
        ...
        "Fix: set CHAINBREAKER_GATEWAY_TOKEN/CHAINBREAKER_GATEWAY_PASSWORD, pass explicit --token/--password,",
...
export function resolveGatewayCredentialsFromConfig(params: {
  ...
  const localTokenPrecedence =
    ...
    (env.CHAINBREAKER_SERVICE_KIND === "gateway" ? "config-first" : "env-first");
