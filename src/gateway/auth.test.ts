...
describe("gateway auth", () => {
    ...
    expect(
      resolveGatewayAuth({
        ...
        env: {
          ...
          CHAINBREAKER_GATEWAY_PASSWORD: "env-password",
  ...
  it("accepts password mode when env provides CHAINBREAKER_GATEWAY_PASSWORD", () => {
...
describe("trusted-proxy auth", () => {
  ...
  it.each([
    ...
    },
    {
      ...
      env: {
        CHAINBREAKER_GATEWAY_TOKEN: "shared-secret",
      } as NodeJS.ProcessEnv,
    },
