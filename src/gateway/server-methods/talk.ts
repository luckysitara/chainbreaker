...
import type { ChainbreakerConfig, TtsConfig, TtsProviderConfigMap } from "../../config/types.js";
...
function buildTalkTtsConfig(
  ...
  | { cfg: ChainbreakerConfig; provider: string; providerConfig: TalkProviderConfig }
  | { error: string } {
