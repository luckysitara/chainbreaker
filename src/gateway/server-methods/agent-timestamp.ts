 ...
 *
 * @see https://github.com/chainbreaker/chainbreaker/issues/3658
 */
...
/**
 * Build TimestampInjectionOptions from an ChainbreakerConfig.
 */
export function timestampOptsFromConfig(cfg: ChainbreakerConfig): TimestampInjectionOptions {
  return {
