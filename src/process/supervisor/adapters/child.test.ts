...
describe("createChildAdapter", () => {
  const originalServiceMarker = process.env.CHAINBREAKER_SERVICE_MARKER;
  ...
  beforeEach(() => {
    ...
    delete process.env.CHAINBREAKER_SERVICE_MARKER;
    vi.useRealTimers();
  });
  ...
  afterAll(() => {
    if (originalServiceMarker === undefined) {
      ...
      process.env.CHAINBREAKER_SERVICE_MARKER = originalServiceMarker;
    }
  });
