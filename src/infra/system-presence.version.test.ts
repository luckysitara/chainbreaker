  ...
  return withEnvAsync(
    {
      ...
      CHAINBREAKER_SERVICE_VERSION: undefined,
...
describe("system-presence version fallback", () => {
  ...
  it("uses runtime VERSION when CHAINBREAKER_VERSION is not set", async () => {
  ...
  it("prefers CHAINBREAKER_VERSION over runtime VERSION", async () => {
    await expectSelfVersion(
      {
  ...
  it("still prefers runtime VERSION over CHAINBREAKER_SERVICE_VERSION when CHAINBREAKER_VERSION is blank", async () => {
    await expectSelfVersion(
      {
  ...
  it("uses runtime VERSION when CHAINBREAKER_VERSION and CHAINBREAKER_SERVICE_VERSION are blank", async () => {
    await expectSelfVersion(
      {
        CHAINBREAKER_VERSION: " ",
        CHAINBREAKER_SERVICE_VERSION: "\t",
