 ...
 * returning control to the caller (typically `triggerChainbreakerRestart` →
...
/**
 * Parse chainbreaker gateway PIDs from lsof -Fpc stdout.
 ...
 * Returns only PIDs that belong to chainbreaker gateway processes (not the current process).
 */
