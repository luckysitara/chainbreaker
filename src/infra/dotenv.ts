...
const BLOCKED_WORKSPACE_DOTENV_KEYS = new Set([
  ...
  "CHAINBREAKER_BUNDLED_HOOKS_DIR",
  "CHAINBREAKER_BUNDLED_PLUGINS_DIR",
  "CHAINBREAKER_BUNDLED_SKILLS_DIR",
  "CHAINBREAKER_CONFIG_PATH",
  "CHAINBREAKER_GATEWAY_PASSWORD",
  "CHAINBREAKER_GATEWAY_SECRET",
  "CHAINBREAKER_GATEWAY_TOKEN",
  "CHAINBREAKER_HOME",
  "CHAINBREAKER_LIVE_ANTHROPIC_KEY",
  "CHAINBREAKER_LIVE_ANTHROPIC_KEYS",
  "CHAINBREAKER_LIVE_GEMINI_KEY",
  "CHAINBREAKER_LIVE_OPENAI_KEY",
  "CHAINBREAKER_OAUTH_DIR",
  "CHAINBREAKER_PROFILE",
...
function shouldBlockRuntimeDotEnvKey(key: string): boolean {
  // The global ~/.chainbreaker/.env (or CHAINBREAKER_STATE_DIR/.env) is a trusted
...
export function loadDotEnv(opts?: { quiet?: boolean }) {
  ...
  // Then load global fallback: ~/.chainbreaker/.env (or CHAINBREAKER_STATE_DIR/.env),
