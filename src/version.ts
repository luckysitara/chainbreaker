...
declare const __CHAINBREAKER_VERSION__: string | undefined;
const CORE_PACKAGE_NAME = "chainbreaker";
...
function resolveVersionFromRuntimeSources(params: {
  ...
  const preferredCandidates =
    params.preference === "env-first"
      ? [params.env["CHAINBREAKER_VERSION"], params.runtimeVersion]
      : [params.runtimeVersion, params.env["CHAINBREAKER_VERSION"]];
  return (
    firstNonEmpty(
      ...preferredCandidates,
      params.env["CHAINBREAKER_SERVICE_VERSION"],
...
// Single source of truth for the current Chainbreaker version.
