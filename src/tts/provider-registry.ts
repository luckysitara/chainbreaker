...
function resolveSpeechProviderPluginEntries(cfg?: ChainbreakerConfig): SpeechProviderPlugin[] {
...
function buildProviderMaps(cfg?: ChainbreakerConfig): {
...
export function listSpeechProviders(cfg?: ChainbreakerConfig): SpeechProviderPlugin[] {
