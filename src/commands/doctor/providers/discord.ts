...
export function scanDiscordNumericIdEntries(cfg: ChainbreakerConfig): DiscordNumericIdHit[] {
...
export function maybeRepairDiscordNumericIds(cfg: ChainbreakerConfig): {
