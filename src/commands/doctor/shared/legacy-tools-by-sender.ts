...
export function scanLegacyToolsBySenderKeys(cfg: ChainbreakerConfig): LegacyToolsBySenderKeyHit[] {
...
export function maybeRepairLegacyToolsBySenderKeys(cfg: ChainbreakerConfig): {
