...
function collectExecSafeBinScopes(cfg: ChainbreakerConfig): ExecSafeBinScopeRef[] {
...
export function scanExecSafeBinCoverage(cfg: ChainbreakerConfig): ExecSafeBinCoverageHit[] {
