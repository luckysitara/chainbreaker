...
export function summarizeExistingConfig(config: ChainbreakerConfig): string {
  const rows: string[] = [];
...
export function formatControlUiSshHint(params: {
  ...
  return [
    ...
    authedUrl,
    "Docs:",
    "https://docs.chainbreaker.ai/gateway/remote",
    "https://docs.chainbreaker.ai/web/control-ui",
  ]
    .filter(Boolean)
    .join("\n");
}
