...
export function createStatusScanConfig<T extends object = ChainbreakerConfig>(
  overrides: T = {} as T,
): ChainbreakerConfig & T {
  return {
    session: {},
    gateway: {},
    ...overrides,
  } as ChainbreakerConfig & T;
}
...
export function createStatusMemorySearchConfig(): ChainbreakerConfig {
