...
export async function dashboardCommand(
  ...
  if (resolvedToken.unresolvedRefReason) {
    ...
    runtime.log(
      "Set CHAINBREAKER_GATEWAY_TOKEN in this shell or resolve your secret provider, then rerun `chainbreaker dashboard`.",
    );
  }
  ...
  if (opened) {
    runtime.log("Opened in your browser. Keep that tab to control Chainbreaker.");
  } else if (hint) {
    runtime.log(hint);
  }
}
