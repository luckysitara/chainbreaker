...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.chainbreaker.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("chainbreaker hooks list")}`,
      `  ${formatCliCommand("chainbreaker hooks enable <name>")}`,
      `  ${formatCliCommand("chainbreaker hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
