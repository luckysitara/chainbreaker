...
function listAccountIds(cfg: ChainbreakerConfig, channel: ChatChannel): string[] {
...
export async function channelsRemoveCommand(
  ...
  let cfg = (configSnapshot.sourceConfig ?? configSnapshot.config) as ChainbreakerConfig;
