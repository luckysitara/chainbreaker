...
import { replaceConfigFile, type ChainbreakerConfig } from "../../config/config.js";
...
function resolveCatalogChannelEntry(raw: string, cfg: ChainbreakerConfig | null) {
...
export async function channelsAddCommand(
  ...
  const cfg = (configSnapshot.sourceConfig ?? configSnapshot.config) as ChainbreakerConfig;
  ...
  // May trigger loadChainbreakerPlugins on cache miss (disk scan + jiti import)
