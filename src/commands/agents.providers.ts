...
function resolveDefaultAccountId(cfg: ChainbreakerConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: ChainbreakerConfig): boolean {
...
export function summarizeBindings(cfg: ChainbreakerConfig, bindings: AgentBinding[]): string[] {
