...
type ChainbreakerReadToolOptions = {
...
function resolveAdaptiveReadMaxBytes(options?: ChainbreakerReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createChainbreakerReadTool(base, {
...
export function createChainbreakerReadTool(
  base: AnyAgentTool,
  options?: ChainbreakerReadToolOptions,
): AnyAgentTool {
