...
export function createPiToolsSandboxContext(params: PiToolsSandboxContextParams): SandboxContext {
  ...
  return {
    ...
    runtimeId: params.containerName ?? "chainbreaker-sbx-test",
    runtimeLabel: params.containerName ?? "chainbreaker-sbx-test",
    containerName: params.containerName ?? "chainbreaker-sbx-test",
