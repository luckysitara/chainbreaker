...
type ChainbreakerToolsDeps = {
  callGateway: typeof callGateway;
  config?: ChainbreakerConfig;
};

const defaultChainbreakerToolsDeps: ChainbreakerToolsDeps = {
  callGateway,
};

let openClawToolsDeps: ChainbreakerToolsDeps = defaultChainbreakerToolsDeps;

export function createChainbreakerTools(
  options?: {
...
export const __testing = {
  setDepsForTest(overrides?: Partial<ChainbreakerToolsDeps>) {
    openClawToolsDeps = overrides
      ? {
          ...defaultChainbreakerToolsDeps,
          ...overrides,
        }
      : defaultChainbreakerToolsDeps;
  },
