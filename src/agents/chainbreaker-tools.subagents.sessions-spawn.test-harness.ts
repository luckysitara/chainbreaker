...
export type CreateChainbreakerToolsOpts = Parameters<CreateSessionsSpawnTool>[0];
...
export async function getSessionsSpawnTool(opts: CreateChainbreakerToolsOpts) {
