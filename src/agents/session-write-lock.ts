...
const CLEANUP_STATE_KEY = Symbol.for("chainbreaker.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("chainbreaker.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("chainbreaker.sessionWriteLockWatchdogState");
