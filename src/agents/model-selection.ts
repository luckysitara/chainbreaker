...
export function isCliProvider(provider: string, cfg?: ChainbreakerConfig): boolean {
...
function resolveAllowedFallbacks(params: { cfg: ChainbreakerConfig; agentId?: string }): string[] {
  if (params.agentId) {
