...
function createSandboxContext(overrides?: Partial<SandboxContext>): SandboxContext {
  const base = {
    ...
    workspaceDir: "/tmp/chainbreaker-sandbox",
    agentWorkspaceDir: "/tmp/chainbreaker-workspace",
    workspaceAccess: "none",
    runtimeId: "chainbreaker-sbx-test",
    runtimeLabel: "chainbreaker-sbx-test",
    containerName: "chainbreaker-sbx-test",
    ...
    browser: {
      ...
      containerName: "chainbreaker-sbx-browser-test",
    },
