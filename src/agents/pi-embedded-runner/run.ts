...
export async function runEmbeddedPiAgent(
  ...
  return enqueueSession(() =>
    enqueueGlobal(async () => {
      ...
      await ensureChainbreakerModelsJson(params.config, agentDir);
      ...
      try {
        ...
        while (true) {
          ...
          if (shouldRotate) {
            ...
            // See: https://github.com/chainbreaker/chainbreaker/issues/58348
            ...
            // See: https://github.com/chainbreaker/chainbreaker/issues/58572
