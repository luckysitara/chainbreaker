...
import { createChainbreakerCodingTools, resolveToolLoopDetectionConfig } from "../../pi-tools.js";
...
export async function runEmbeddedAttempt(
  ...
  try {
    ...
    const agentDir = params.agentDir ?? resolveChainbreakerAgentDir();
    ...
    try {
      ...
      try {
        ...
        // double-compaction. See: https://github.com/chainbreaker/chainbreaker/issues/9282
        ...
        if (promptError && promptErrorSource === "prompt" && !compactionOccurredThisAttempt) {
          try {
            sessionManager.appendCustomEntry("chainbreaker:prompt-error", {
              timestamp: Date.now(),
              runId: params.runId,
              sessionId: params.sessionId,
              provider: params.provider,
      ...
      // See: https://github.com/chainbreaker/chainbreaker/issues/8643
