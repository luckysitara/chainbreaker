...
export const createChainbreakerCodingToolsMock = vi.fn(() => []);
...
export function resetCompactHooksHarnessMocks(): void {
  ...
  createChainbreakerCodingToolsMock.mockReset();
...
export async function loadCompactHooksHarness(): Promise<{
  ...
  vi.doMock("../models-config.js", () => ({
    ensureChainbreakerModelsJson: vi.fn(async () => {}),
  }));
  ...
  vi.doMock("../docs-path.js", () => ({
    resolveChainbreakerDocsPath: vi.fn(async () => undefined),
  }));
  ...
  vi.doMock("../pi-tools.js", () => ({
    createChainbreakerCodingTools: createChainbreakerCodingToolsMock,
  }));
  ...
  vi.doMock("../agent-paths.js", () => ({
    resolveChainbreakerAgentDir: vi.fn(() => "/tmp"),
  }));
