      ...
      switch (params.provider) {
        case "ollama":
          return (
            ...
            'Set OLLAMA_API_KEY="ollama-local" (any value works) or run "chainbreaker configure". ' +
            "See: https://docs.chainbreaker.ai/providers/ollama"
          );
        case "vllm":
          return (
            "vLLM requires authentication to be registered as a provider. " +
            'Set VLLM_API_KEY (any value works) or run "chainbreaker configure". ' +
            "See: https://docs.chainbreaker.ai/providers/vllm"
          );
        default:
          return undefined;
      }
