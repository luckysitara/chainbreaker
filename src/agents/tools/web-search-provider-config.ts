...
export type WebSearchConfig = NonNullable<ChainbreakerConfig["tools"]>["web"] extends infer Web
...
export function resolveSearchConfig(cfg?: ChainbreakerConfig): WebSearchConfig {
