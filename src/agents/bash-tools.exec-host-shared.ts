...
export function buildHeadlessExecApprovalDeniedMessage(params: {
  ...
  return [
    ...
    "Stricter values from tools.exec and ~/.chainbreaker/exec-approvals.json both apply.",
    "Fix one of these:",
    ...
    'Tip: run "chainbreaker doctor" and "chainbreaker approvals get --gateway" to inspect the effective policy.',
  ].join("\n");
}
