...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveChainbreakerAgentDir() returns mainAgentDir
    process.env.CHAINBREAKER_STATE_DIR = tmpDir;
    process.env.CHAINBREAKER_AGENT_DIR = mainAgentDir;
