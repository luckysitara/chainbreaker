...
export const DEFAULT_SANDBOX_IMAGE = "chainbreaker-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "chainbreaker-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "chainbreaker-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "chainbreaker-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "chainbreaker-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "chainbreaker-sandbox-browser";
