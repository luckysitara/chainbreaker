...
function resolveAvatarSource(cfg: ChainbreakerConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: ChainbreakerConfig, agentId: string): AgentAvatarResolution {
