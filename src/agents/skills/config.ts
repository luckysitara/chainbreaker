import type { ChainbreakerConfig, SkillConfig } from "../../config/config.js";
import {
...
const BUNDLED_SOURCES = new Set(["chainbreaker-bundled"]);

function isBundledSkill(entry: SkillEntry): boolean {
  return BUNDLED_SOURCES.has(resolveSkillSource(entry.skill));
}

export function resolveBundledAllowlist(config?: ChainbreakerConfig): string[] | undefined {
