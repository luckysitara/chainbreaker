...
function resolveWatchPaths(workspaceDir: string, config?: ChainbreakerConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: ChainbreakerConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: ChainbreakerConfig }) {
