...
function resolveAnthropicOpusThinking(cfg: ChainbreakerConfig) {
...
function createProviderWithModelsConfig(provider: string, models: Array<Record<string, unknown>>) {
  ...
  } as Partial<ChainbreakerConfig>;
}

function resolveConfiguredRefForTest(cfg: Partial<ChainbreakerConfig>) {
...
describe("model-selection", () => {
  ...
  describe("buildModelAliasIndex", () => {
    it("should build alias index from config", () => {
      const cfg: Partial<ChainbreakerConfig> = {
        agents: {
          defaults: {
            models: {
