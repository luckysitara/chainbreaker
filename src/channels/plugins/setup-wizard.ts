...
export type ChannelSetupWizardStatus = {
  ...
  resolveConfigured: (params: { cfg: ChainbreakerConfig }) => boolean | Promise<boolean>;
...
export type ChannelSetupWizardEnvShortcut = {
  ...
  isAvailable: (params: { cfg: ChainbreakerConfig; accountId: string }) => boolean;
  apply: (params: {
    cfg: ChainbreakerConfig;
    accountId: string;
...
export type ChannelSetupWizardCredential = {
  ...
  keepPrompt: string;
  inputPrompt: string;
  allowEnv?: (params: { cfg: ChainbreakerConfig; accountId: string }) => boolean;
  inspect: (params: {
    cfg: ChainbreakerConfig;
    accountId: string;
...
export type ChannelSetupWizardGroupAccess = {
  ...
  currentPolicy: (params: { cfg: ChainbreakerConfig; accountId: string }) => ChannelAccessPolicy;
  currentEntries: (params: { cfg: ChainbreakerConfig; accountId: string }) => string[];
  updatePrompt: (params: { cfg: ChainbreakerConfig; accountId: string }) => boolean;
  setPolicy: (params: {
    cfg: ChainbreakerConfig;
    accountId: string;
...
export type ChannelSetupWizard = {
  ...
  disable?: (cfg: ChainbreakerConfig) => ChainbreakerConfig;
