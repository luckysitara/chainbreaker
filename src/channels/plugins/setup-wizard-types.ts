...
export type ChannelOnboardingPostWriteHook = {
  channel: ChannelId;
  accountId: string;
  run: (ctx: { cfg: ChainbreakerConfig; runtime: RuntimeEnv }) => Promise<void> | void;
};
...
export type ChannelSetupDmPolicy = {
  ...
  getCurrent: (cfg: ChainbreakerConfig, accountId?: string) => DmPolicy;
  setPolicy: (cfg: ChainbreakerConfig, policy: DmPolicy, accountId?: string) => ChainbreakerConfig;
