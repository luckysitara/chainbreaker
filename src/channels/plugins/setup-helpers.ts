...
function channelHasAccounts(cfg: ChainbreakerConfig, channelKey: string): boolean {
...
export function createZodSetupInputValidator<T extends ChannelSetupInput>(params: {
  schema: ZodType<T>;
  validate?: (params: { cfg: ChainbreakerConfig; accountId: string; input: T }) => string | null;
