...
export type ChannelAgentToolFactory = (params: { cfg?: ChainbreakerConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: ChainbreakerConfig; accountId?: string | null }) => string[];
