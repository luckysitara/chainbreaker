...
export type ChannelSetupAdapter = {
  ...
  afterAccountConfigWritten?: (params: {
    previousCfg: ChainbreakerConfig;
    cfg: ChainbreakerConfig;
    accountId: string;
    input: ChannelSetupInput;
    runtime: RuntimeEnv;
...
export type ChannelConfigAdapter<ResolvedAccount> = {
  ...
  resolveAccount: (cfg: ChainbreakerConfig, accountId?: string | null) => ResolvedAccount;
  inspectAccount?: (cfg: ChainbreakerConfig, accountId?: string | null) => unknown;
  defaultAccountId?: (cfg: ChainbreakerConfig) => string;
  setAccountEnabled?: (params: {
    cfg: ChainbreakerConfig;
    accountId: string;
    enabled: boolean;
  }) => ChainbreakerConfig;
  deleteAccount?: (params: { cfg: ChainbreakerConfig; accountId: string }) => ChainbreakerConfig;
  isEnabled?: (account: ResolvedAccount, cfg: ChainbreakerConfig) => boolean;
  disabledReason?: (account: ResolvedAccount, cfg: ChainbreakerConfig) => string;
  isConfigured?: (account: ResolvedAccount, cfg: ChainbreakerConfig) => boolean | Promise<boolean>;
  unconfiguredReason?: (account: ResolvedAccount, cfg: ChainbreakerConfig) => string;
  describeAccount?: (account: ResolvedAccount, cfg: ChainbreakerConfig) => ChannelAccountSnapshot;
...
export type ChannelGatewayContext<ResolvedAccount = unknown> = {
   ...
   * @see {@link https://docs.chainbreaker.ai/plugins/developing-plugins | Plugin SDK documentation}
   */
...
export type ChannelLifecycleAdapter = {
  onAccountConfigChanged?: (params: {
    prevCfg: ChainbreakerConfig;
    nextCfg: ChainbreakerConfig;
    accountId: string;
    runtime: RuntimeEnv;
  }) => Promise<void> | void;
...
export type ChannelApprovalDeliveryAdapter = {
  hasConfiguredDmRoute?: (params: { cfg: ChainbreakerConfig }) => boolean;
...
export type ChannelAllowlistAdapter = {
  applyConfigEdit?: (params: {
    ...
    | Promise<
      ...
      >
    | null;
  readConfig?: (params: { cfg: ChainbreakerConfig; accountId?: string | null }) =>
    | {
...
export type ChannelConversationBindingSupport = {
  ...
  createManager?: (params: { cfg: ChainbreakerConfig; accountId?: string | null }) =>
    | {
