...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: ChainbreakerConfig): string | undefined {
  ...
  function listAccountIds(cfg: ChainbreakerConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: ChainbreakerConfig): string {
