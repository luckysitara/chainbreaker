...
function resolveAcpStreamCoalesceIdleMs(cfg: ChainbreakerConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: ChainbreakerConfig): number {
...
export function resolveAcpProjectionSettings(cfg: ChainbreakerConfig): AcpProjectionSettings {
