  ...
  it("resolves known variables, aliases, and case-insensitive tokens", () => {
    const cases = [
      ...
      },
      {
        ...
        values: { identityName: "Chainbreaker" },
        expected: "[Chainbreaker]",
      },
      {
      ...
      },
      {
        ...
        values: {
          identityName: "Chainbreaker",
          provider: "anthropic",
          model: "claude-opus-4-5",
          thinkingLevel: "high",
        },
        expected: "[Chainbreaker] anthropic/claude-opus-4-5 (think:high)",
      },
    ] as const;
