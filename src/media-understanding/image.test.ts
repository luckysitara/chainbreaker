...
const hoisted = vi.hoisted(() => ({
  completeMock: vi.fn(),
  ensureChainbreakerModelsJsonMock: vi.fn(async () => {}),
...
const {
  completeMock,
  ensureChainbreakerModelsJsonMock,
...
vi.mock("../agents/models-config.js", async (importOriginal) => ({
  ...
  ensureChainbreakerModelsJson: ensureChainbreakerModelsJsonMock,
}));
