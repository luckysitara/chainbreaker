...
function expectLaunchctlEnableBootstrapOrder(env: Record<string, string | undefined>) {
  ...
  const label = "ai.chainbreaker.gateway";
...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.chainbreaker.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", CHAINBREAKER_PROFILE: "default" },
    });
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.chainbreaker.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when CHAINBREAKER_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.chainbreaker.gateway.plist",
    },
    {
      name: "uses profile-specific label when CHAINBREAKER_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", CHAINBREAKER_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.chainbreaker.jbphoenix.plist",
    },
    {
      name: "prefers CHAINBREAKER_LAUNCHD_LABEL over CHAINBREAKER_PROFILE",
      env: {
        HOME: "/Users/test",
        CHAINBREAKER_PROFILE: "jbphoenix",
        CHAINBREAKER_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from CHAINBREAKER_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        CHAINBREAKER_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty CHAINBREAKER_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        CHAINBREAKER_PROFILE: "myprofile",
        CHAINBREAKER_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.chainbreaker.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
