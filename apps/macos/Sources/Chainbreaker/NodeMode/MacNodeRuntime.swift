...
actor MacNodeRuntime {
    ...
    func handleInvoke(_ req: BridgeInvokeRequest) async -> BridgeInvokeResponse {
        ...
        do {
            ...
            case ChainbreakerBrowserCommand.proxy.rawValue:
            ...
            case ChainbreakerLocationCommand.get.rawValue:
                return try await self.handleLocationInvoke(req)
            case MacNodeScreenCommand.record.rawValue:
                return try await self.handleScreenRecordInvoke(req)
            case ChainbreakerSystemCommand.run.rawValue:
                return try await self.handleSystemRun(req)
            case ChainbreakerSystemCommand.which.rawValue:
                return try await self.handleSystemWhich(req)
            case ChainbreakerSystemCommand.notify.rawValue:
                return try await self.handleSystemNotify(req)
            case ChainbreakerSystemCommand.execApprovalsGet.rawValue:
                return try await self.handleSystemExecApprovalsGet(req)
            case ChainbreakerSystemCommand.execApprovalsSet.rawValue:
    ...
    private func handleA2UIInvoke(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        ...
        case ChainbreakerCanvasA2UICommand.push.rawValue,
             ChainbreakerCanvasA2UICommand.pushJSONL.rawValue:
    ...
    private func handleBrowserProxyInvoke(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        guard ChainbreakerConfigFile.browserControlEnabled() else {
            return BridgeInvokeResponse(
                id: req.id,
                ok: false,
                error: ChainbreakerNodeError(
    ...
    private func resolveA2UIHostUrl() async -> String? {
        ...
        return baseUrl.appendingPathComponent("__chainbreaker__/a2ui/").absoluteString + "?platform=macos"
    }
    ...
    private func handleSystemRun(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        let params = try Self.decodeParams(ChainbreakerSystemRunParams.self, from: req.paramsJSON)
    ...
    private func handleSystemWhich(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        let params = try Self.decodeParams(ChainbreakerSystemWhichParams.self, from: req.paramsJSON)
    ...
    private func resolveSystemRunApproval(
        ...
        params: ChainbreakerSystemRunParams,
...
extension MacNodeRuntime {
    ...
    private nonisolated static func locationMode() -> ChainbreakerLocationMode {
    ...
    private static func errorResponse(
        ...
        code: ChainbreakerNodeErrorCode,
        message: String) -> BridgeInvokeResponse
    {
        BridgeInvokeResponse(
            id: req.id,
            ok: false,
            error: ChainbreakerNodeError(code: code, message: message))
    }

    private static func encodeCanvasSnapshot(
        image: NSImage,
        format: ChainbreakerCanvasSnapshotFormat,
        maxWidth: Int?,
