...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.chainbreaker", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Chainbreaker windows, but below the system’s pop-up menus.
