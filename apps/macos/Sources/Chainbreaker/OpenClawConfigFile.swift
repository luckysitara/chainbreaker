...
enum ChainbreakerConfigFile {
    private static let logger = Logger(subsystem: "ai.chainbreaker", category: "config")
    private static let configAuditFileName = "config-audit.jsonl"
    private static let configHealthFileName = "config-health.json"

    static func url() -> URL {
        ChainbreakerPaths.configURL
    }

    static func stateDirURL() -> URL {
        ChainbreakerPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        ChainbreakerPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-chainbreaker-config-file",
            "event": "config.write",
