...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.chainbreaker", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".chainbreaker/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.chainbreakerCommand(
            subcommand: "gateway",
