...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = ChainbreakerConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = ChainbreakerConfigFile.url()
    ...
    func syncGatewayConfigNow() {
        ...
        let synced = Self.syncedGatewayRoot(
            currentRoot: ChainbreakerConfigFile.loadDict(),
        ...
        ChainbreakerConfigFile.saveDict(synced.root)
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/chainbreaker"
        state.remoteCliPath = ""
        return state
    }
}
