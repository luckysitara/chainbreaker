...
private let onboardingWizardLogger = Logger(subsystem: "ai.chainbreaker", category: "onboarding.wizard")

// MARK: - Swift 6 AnyCodable Bridging Helpers

// Bridge between ChainbreakerProtocol.AnyCodable and the local module to avoid
// Swift 6 strict concurrency type conflicts.

private typealias ProtocolAnyCodable = ChainbreakerProtocol.AnyCodable
