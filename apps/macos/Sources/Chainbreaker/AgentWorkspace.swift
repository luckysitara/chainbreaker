...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.chainbreaker", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return ChainbreakerConfigFile.defaultWorkspaceURL() }
    ...
    static func defaultTemplate() -> String {
        let fallback = """
        # AGENTS.md - Chainbreaker Workspace
    ...
    static func defaultBootstrapTemplate() -> String {
        ...
        3) ~/.chainbreaker/chainbreaker.json
