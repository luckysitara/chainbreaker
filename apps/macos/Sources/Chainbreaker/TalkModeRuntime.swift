...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.chainbreaker", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.chainbreaker", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [ChainbreakerChatMessage] = messages.compactMap { item in
