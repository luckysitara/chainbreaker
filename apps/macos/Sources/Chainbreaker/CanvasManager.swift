...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.chainbreaker", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Chainbreaker/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__chainbreaker__/a2ui/").absoluteString + "?platform=macos"
    }
