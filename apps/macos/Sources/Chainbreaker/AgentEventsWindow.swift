...
private struct EventRow: View {
    ...
    private func prettyJSON(_ dict: [String: ChainbreakerProtocol.AnyCodable]) -> String? {
...
struct AgentEventsWindow_Previews: PreviewProvider {
    static var previews: some View {
        let sample = ControlAgentEvent(
            ...
            data: [
                "phase": ChainbreakerProtocol.AnyCodable("start"),
                "name": ChainbreakerProtocol.AnyCodable("bash"),
            ],
            summary: nil)
