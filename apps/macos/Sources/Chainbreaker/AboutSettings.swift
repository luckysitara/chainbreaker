...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/chainbreaker/chainbreaker") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/chainbreaker/chainbreaker")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://chainbreaker.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "ChainbreakerBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "ChainbreakerBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "ChainbreakerGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "ChainbreakerGitCommit") as? String) ??
            "unknown"
    }
