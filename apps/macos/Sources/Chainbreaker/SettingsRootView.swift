...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .chainbreakerSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? ChainbreakerPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? ChainbreakerPaths.stateDirURL.path
...
extension Notification.Name {
    static let chainbreakerSelectSettingsTab = Notification.Name("chainbreakerSelectSettingsTab")
}
