...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.chainbreaker", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        ChainbreakerPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        ChainbreakerPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
