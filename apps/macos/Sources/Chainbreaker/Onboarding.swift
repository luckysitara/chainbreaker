...
enum UIStrings {
    static let welcomeTitle = "Welcome to Chainbreaker"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "chainbreaker.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: ChainbreakerChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g chainbreaker@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: ChainbreakerChatViewModel(
