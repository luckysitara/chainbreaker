...
import ai.chainbreaker.app.voice.VoiceConversationRole
  ...
  Row(
    ...
    Surface(
      ...
      Column(
        ...
        Text(
          if (isUser) "You" else "Chainbreaker",
  ...
  Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Start) {
    Surface(
      ...
      Row(
        ...
        Text("Chainbreaker is thinking…", style = mobileCallout, color = mobileTextSecondary)
      }
    }
  }
}
