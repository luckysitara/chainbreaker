...
import ai.chainbreaker.app.gateway.GatewayClientInfo
import ai.chainbreaker.app.gateway.GatewayConnectOptions
import ai.chainbreaker.app.gateway.GatewayEndpoint
import ai.chainbreaker.app.gateway.GatewayTlsParams
...
class ConnectionManager(
  ...
  fun buildUserAgent(): String {
    ...
    return "ChainbreakerAndroid/$version (Android $releaseLabel; SDK ${Build.VERSION.SDK_INT})"
  }
  ...
  fun buildNodeConnectOptions(): GatewayConnectOptions {
    return GatewayConnectOptions(
      ...
      client = buildClientInfo(clientId = "chainbreaker-android", clientMode = "node"),
  ...
  fun buildOperatorConnectOptions(): GatewayConnectOptions {
    return GatewayConnectOptions(
      ...
      commands = emptyList(),
      permissions = emptyMap(),
      client = buildClientInfo(clientId = "chainbreaker-android", clientMode = "ui"),
      userAgent = buildUserAgent(),
    )
  }
