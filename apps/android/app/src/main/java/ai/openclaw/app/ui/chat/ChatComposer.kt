...
import ai.chainbreaker.app.ui.mobileAccentBorderStrong
...
import ai.chainbreaker.app.ui.mobileSurface
import ai.chainbreaker.app.ui.mobileText
import ai.chainbreaker.app.ui.mobileTextSecondary
import ai.chainbreaker.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.chainbreaker.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.chainbreaker.app.ui.mobileFontFamily,
