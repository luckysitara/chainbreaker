  ...
  AndroidView(
    ...
    factory = {
      WebView(context).apply {
        ...
        if (isDebuggable) {
          Log.d("ChainbreakerWebView", "userAgent: ${settings.userAgentString}")
        }
        ...
        webViewClient =
          object : WebViewClient() {
            ...
            override fun onReceivedError(
              ...
              Log.e("ChainbreakerWebView", "onReceivedError: ${error.errorCode} ${error.description} ${request.url}")
            }
            ...
            override fun onPageFinished(view: WebView, url: String?) {
              currentPageUrlRef.set(url)
              if (isDebuggable) {
                Log.d("ChainbreakerWebView", "onPageFinished: $url")
              }
...
private class CanvasA2UIActionBridge(
  ...
  companion object {
    const val interfaceName: String = "chainbreakerCanvasA2UIAction"
  }
}
