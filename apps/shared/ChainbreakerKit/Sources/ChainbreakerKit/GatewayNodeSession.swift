...
private func replaceCanvasCapabilityInScopedHostUrl(scopedUrl: String, capability: String) -> String? {
    let marker = "/__chainbreaker__/cap/"
...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.chainbreaker", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.chainbreaker", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: ChainbreakerProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
