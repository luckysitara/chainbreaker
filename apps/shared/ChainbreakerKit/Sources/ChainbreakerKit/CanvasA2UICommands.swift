...
public enum ChainbreakerCanvasA2UICommand: String, Codable, Sendable {
...
public struct ChainbreakerCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct ChainbreakerCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
