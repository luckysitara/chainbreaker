...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: ChainbreakerProtocol.AnyCodable]?
    {
        ...
        return [
            "id": ChainbreakerProtocol.AnyCodable(identity.deviceId),
            "publicKey": ChainbreakerProtocol.AnyCodable(publicKey),
            "signature": ChainbreakerProtocol.AnyCodable(signature),
            "signedAt": ChainbreakerProtocol.AnyCodable(signedAtMs),
            "nonce": ChainbreakerProtocol.AnyCodable(nonce),
        ]
    }
}
