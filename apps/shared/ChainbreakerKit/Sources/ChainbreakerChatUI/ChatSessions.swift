...
public struct ChainbreakerChatModelChoice: Identifiable, Codable, Sendable, Hashable {
...
public struct ChainbreakerChatSessionsDefaults: Codable, Sendable {
...
public struct ChainbreakerChatSessionEntry: Codable, Identifiable, Sendable, Hashable {
...
public struct ChainbreakerChatSessionsListResponse: Codable, Sendable {
    public let ts: Double?
    public let path: String?
    public let count: Int?
    public let defaults: ChainbreakerChatSessionsDefaults?
    public let sessions: [ChainbreakerChatSessionEntry]
    ...
    public init(
        ...
        sessions: [ChainbreakerChatSessionEntry])
    {
        self.ts = ts
        self.path = path
        self.count = count
