...
extension NodeAppModel {
    func resolveCanvasHostURL() async -> String? {
        ...
        return base.appendingPathComponent("__chainbreaker__/canvas/").absoluteString
    }
    ...
    func resolveA2UIHostURL() async -> String? {
        ...
        return base.appendingPathComponent("__chainbreaker__/a2ui/").absoluteString + "?platform=ios"
    }
