...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.chainbreaker.gateway"
    private static let nodeService = "ai.chainbreaker.node"
    private static let talkService = "ai.chainbreaker.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.chainbreaker.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.chainbreaker.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?
            .appendingPathComponent("chainbreaker-gateway.log")
    }
