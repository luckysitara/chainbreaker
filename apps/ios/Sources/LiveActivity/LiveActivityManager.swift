...
final class LiveActivityManager {
    ...
    private let logger = Logger(subsystem: "ai.chainbreaker.ios", category: "LiveActivity")
    private var currentActivity: Activity<ChainbreakerActivityAttributes>?
    ...
    func startActivity(agentName: String, sessionKey: String) {
        ...
        let attributes = ChainbreakerActivityAttributes(agentName: agentName, sessionKey: sessionKey)
    ...
    private func hydrateCurrentAndPruneDuplicates() {
        let active = Activity<ChainbreakerActivityAttributes>.activities
    ...
    private func updateCurrent(state: ChainbreakerActivityAttributes.ContentState) {
    ...
    private func connectingState() -> ChainbreakerActivityAttributes.ContentState {
        ChainbreakerActivityAttributes.ContentState(
    ...
    private func idleState() -> ChainbreakerActivityAttributes.ContentState {
        ChainbreakerActivityAttributes.ContentState(
            statusText: "Idle",
            isIdle: true,
            isDisconnected: false,
    ...
    private func disconnectedState() -> ChainbreakerActivityAttributes.ContentState {
        ChainbreakerActivityAttributes.ContentState(
