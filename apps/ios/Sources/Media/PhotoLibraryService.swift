...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: ChainbreakerPhotosLatestParams) async throws -> ChainbreakerPhotosLatestPayload {
        ...
        var results: [ChainbreakerPhotoPayload] = []
        ...
        return ChainbreakerPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> ChainbreakerPhotoPayload
    {
        ...
        return ChainbreakerPhotoPayload(
            format: "jpeg",
