...
final class CalendarService: CalendarServicing {
    func events(params: ChainbreakerCalendarEventsParams) async throws -> ChainbreakerCalendarEventsPayload {
        ...
        let payload = selected.map { event in
            ChainbreakerCalendarEventPayload(
        ...
        return ChainbreakerCalendarEventsPayload(events: payload)
    }
    ...
    func add(params: ChainbreakerCalendarAddParams) async throws -> ChainbreakerCalendarAddPayload {
        ...
        let payload = ChainbreakerCalendarEventPayload(
            identifier: event.eventIdentifier ?? UUID().uuidString,
        ...
        return ChainbreakerCalendarAddPayload(event: payload)
    }
