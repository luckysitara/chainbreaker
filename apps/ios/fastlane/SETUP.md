# fastlane setup (Chainbreaker iOS)
...
ASC_KEYCHAIN_SERVICE=chainbreaker-asc-key
...
```bash
ASC_APP_IDENTIFIER=ai.chainbreaker.client
# or
...
- The beta flow regenerates `apps/ios/Chainbreaker.xcodeproj` from `apps/ios/project.yml` before archiving
