...
if (rawCli.showHelp) {
  console.log(
    [
      ...
      "",
      "Runs the planner-backed Chainbreaker test wrapper.",
      "",
      "Wrapper flags:",
      ...
      "",
      "Environment:",
      "  CHAINBREAKER_TEST_LIST_LANES=1          Print the resolved plan before execution",
      "  CHAINBREAKER_TEST_SHOW_POOL_DECISION=1  Include thread/fork pool decisions in diagnostics",
    ].join("\n"),
  );
  process.exit(0);
}
...
if (process.env.CHAINBREAKER_TEST_LIST_LANES === "1" || rawCli.plan) {
