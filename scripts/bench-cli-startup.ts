...
const DEFAULT_ENTRY = "chainbreaker.mjs";
...
function printUsage(): void {
  console.log(`Chainbreaker CLI benchmark
...
Options:
  ...
  --entry <path>               Primary entry file (default: chainbreaker.mjs)
...
async function main(): Promise<void> {
  ...
  const tmpDir = mkdtempSync(path.join(os.tmpdir(), "chainbreaker-cli-bench-"));
