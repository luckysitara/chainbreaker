...
const FORBIDDEN_PATTERNS: Array<{ pattern: RegExp; hint: string }> = [
  {
    pattern: /["']chainbreaker\/plugin-sdk["']/,
    hint: "Use chainbreaker/plugin-sdk/<subpath> instead of the monolithic root entry.",
  },
  {
    pattern: /["']chainbreaker\/plugin-sdk\/test-utils["']/,
    hint: "Use chainbreaker/plugin-sdk/testing for the public extension test surface.",
  },
  {
    pattern: /["']chainbreaker\/plugin-sdk\/compat["']/,
  ...
  },
  {
    ...
    hint: "Use test/helpers/plugins/* for repo-only helpers, or chainbreaker/plugin-sdk/testing for public surfaces.",
  },
  {
