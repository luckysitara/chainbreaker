...
export DISPLAY=:1
export HOME=/tmp/chainbreaker-home
export XDG_CONFIG_HOME="${HOME}/.config"
export XDG_CACHE_HOME="${HOME}/.cache"

CDP_PORT="${CHAINBREAKER_BROWSER_CDP_PORT:-9222}"
CDP_SOURCE_RANGE="${CHAINBREAKER_BROWSER_CDP_SOURCE_RANGE:-}"
VNC_PORT="${CHAINBREAKER_BROWSER_VNC_PORT:-5900}"
NOVNC_PORT="${CHAINBREAKER_BROWSER_NOVNC_PORT:-6080}"
ENABLE_NOVNC="${CHAINBREAKER_BROWSER_ENABLE_NOVNC:-1}"
HEADLESS="${CHAINBREAKER_BROWSER_HEADLESS:-0}"
ALLOW_NO_SANDBOX="${CHAINBREAKER_BROWSER_NO_SANDBOX:-0}"
NOVNC_PASSWORD="${CHAINBREAKER_BROWSER_NOVNC_PASSWORD:-}"
DISABLE_GRAPHICS_FLAGS="${CHAINBREAKER_BROWSER_DISABLE_GRAPHICS_FLAGS:-1}"
DISABLE_EXTENSIONS="${CHAINBREAKER_BROWSER_DISABLE_EXTENSIONS:-1}"
RENDERER_PROCESS_LIMIT="${CHAINBREAKER_BROWSER_RENDERER_PROCESS_LIMIT:-2}"
