...
if (!existsSync(generatedFacadeTypeMapDts)) {
  ...
  if (facadeTypeMapContent.includes("@chainbreaker/")) {
    console.error(
      "INVALID GENERATED FACADE TYPE MAP DTS: dist/plugin-sdk/src/generated/plugin-sdk-facade-type-map.generated.d.ts leaks @chainbreaker/* imports",
    );
    missing += 1;
  }
}
