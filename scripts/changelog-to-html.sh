...
if [[ -z "$version_content" ]]; then
  echo "<h2>Chainbreaker $VERSION</h2>"
  echo "<p>Latest Chainbreaker update.</p>"
  echo "<p><a href=\"https://github.com/chainbreaker/chainbreaker/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
