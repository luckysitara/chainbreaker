...
- CHAINBREAKER_GATEWAY_VERSION = exact package.json version
- CHAINBREAKER_MARKETING_VERSION = short iOS/App Store version
- CHAINBREAKER_BUILD_VERSION = explicit build number or local numeric fallback
EOF
}
...
CHAINBREAKER_GATEWAY_VERSION = ${PACKAGE_VERSION}
CHAINBREAKER_MARKETING_VERSION = ${MARKETING_VERSION}
CHAINBREAKER_BUILD_VERSION = ${BUILD_NUMBER}
EOF
