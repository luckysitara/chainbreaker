...
function parseArgs(argv) {
  return parseFlagArgs(
    argv,
    {
      ...
      maxWallMs: readEnvNumber("CHAINBREAKER_TEST_PERF_MAX_WALL_MS"),
      baselineWallMs: readEnvNumber("CHAINBREAKER_TEST_PERF_BASELINE_WALL_MS"),
      maxRegressionPct: readEnvNumber("CHAINBREAKER_TEST_PERF_MAX_REGRESSION_PCT") ?? 10,
    },
    [
...
const reportPath = runVitestJsonReport({
  config: opts.config,
  prefix: "chainbreaker-vitest-perf",
});
