...
export const OPTIONAL_BUNDLED_BUILD_ENV = "CHAINBREAKER_INCLUDE_OPTIONAL_BUNDLED";
...
export function hasReleasedBundledInstall(packageJson) {
  return (
    typeof packageJson?.chainbreaker?.install?.npmSpec === "string" &&
    packageJson.chainbreaker.install.npmSpec.trim().length > 0
  );
}
