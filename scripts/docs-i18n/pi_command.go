...
const (
	envDocsPiExecutable     = "CHAINBREAKER_DOCS_I18N_PI_EXECUTABLE"
	envDocsPiArgs           = "CHAINBREAKER_DOCS_I18N_PI_ARGS"
	envDocsPiPackageVersion = "CHAINBREAKER_DOCS_I18N_PI_PACKAGE_VERSION"
...
func getMaterializedPiRuntimeDir() (string, error) {
	...
	return filepath.Join(cacheDir, "chainbreaker", "docs-i18n", "pi-runtime", getMaterializedPiPackageVersion()), nil
}
