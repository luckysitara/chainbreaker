...
- Keep product names in English: Chainbreaker, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the Chainbreaker Gateway, use “Gateway 网关”.
