import { buildDmGroupAccountAllowlistAdapter } from "chainbreaker/plugin-sdk/allowlist-config-edit";
import { resolveReactionMessageId } from "chainbreaker/plugin-sdk/channel-actions";
import { createChatChannelPlugin } from "chainbreaker/plugin-sdk/core";
import { chunkText } from "chainbreaker/plugin-sdk/reply-runtime";
import {
...
function areWhatsAppAgentReactionsEnabled(params: { cfg: ChainbreakerConfig; accountId?: string }) {
...
function hasAnyWhatsAppAccountWithAgentReactionsEnabled(cfg: ChainbreakerConfig) {
