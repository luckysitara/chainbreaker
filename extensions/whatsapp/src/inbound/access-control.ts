import { createChannelPairingChallengeIssuer } from "chainbreaker/plugin-sdk/channel-pairing";
...
import { isSelfChatMode, normalizeE164 } from "chainbreaker/plugin-sdk/text-runtime";
