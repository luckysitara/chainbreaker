...
export function listWhatsAppAuthDirs(cfg: ChainbreakerConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: ChainbreakerConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: ChainbreakerConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: ChainbreakerConfig): ResolvedWhatsAppAccount[] {
