...
vi.mock("chainbreaker/plugin-sdk/security-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("chainbreaker/plugin-sdk/security-runtime")>();
  return {
    ...actual,
