...
function makeCfg(overrides?: Partial<ChainbreakerConfig>): ChainbreakerConfig {
  return {
    bindings: [],
    channels: {},
    ...overrides,
...
describe("resolveWhatsAppHeartbeatRecipients", () => {
  ...
  function resolveWith(
    cfgOverrides: Partial<ChainbreakerConfig> = {},
  ...
  it("ignores session store when session scope is global", () => {
    ...
    const result = resolveWith({
      session: { scope: "global" } as ChainbreakerConfig["session"],
