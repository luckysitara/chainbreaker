import { definePluginEntry, type ProviderAuthContext } from "chainbreaker/plugin-sdk/plugin-entry";
import {
  coerceSecretRef,
  ensureAuthProfileStore,
  listProfilesForProvider,
} from "chainbreaker/plugin-sdk/provider-auth";
import { githubCopilotLoginCommand } from "chainbreaker/plugin-sdk/provider-auth-login";
