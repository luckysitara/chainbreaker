...
export function resolveTavilySearchConfig(cfg?: ChainbreakerConfig): TavilySearchConfig {
...
export function resolveTavilyApiKey(cfg?: ChainbreakerConfig): string | undefined {
...
export function resolveTavilyBaseUrl(cfg?: ChainbreakerConfig): string {
  const search = resolveTavilySearchConfig(cfg);
  const configured =
