...
import { buildOauthProviderAuthResult } from "chainbreaker/plugin-sdk/provider-auth-result";
import { fetchGeminiUsage } from "chainbreaker/plugin-sdk/provider-usage";
...
export function registerGoogleGeminiCliProvider(api: ChainbreakerPluginApi) {
