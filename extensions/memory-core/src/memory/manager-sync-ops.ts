...
} from "chainbreaker/plugin-sdk/memory-core-host-engine-embeddings";
import {
...
export abstract class MemoryManagerSyncOps {
  protected abstract readonly cfg: ChainbreakerConfig;
      ...
      try {
        ...
        if (activated) {
          if (
            ...
            process.env.CHAINBREAKER_TEST_MEMORY_UNSAFE_REINDEX === "1"
          ) {
