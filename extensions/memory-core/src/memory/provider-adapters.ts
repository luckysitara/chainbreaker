...
import { resolveUserPath } from "chainbreaker/plugin-sdk/memory-core-host-engine-foundation";
import { getProviderEnvVars } from "chainbreaker/plugin-sdk/provider-env-vars";
...
function formatLocalSetupError(err: unknown): string {
  ...
  return [
    ...
    missing
      ? "2) Reinstall Chainbreaker (this should install node-llama-cpp): npm i -g chainbreaker@latest"
      : null,
