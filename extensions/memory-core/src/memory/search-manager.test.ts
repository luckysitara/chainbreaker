...
import type { checkQmdBinaryAvailability as checkQmdBinaryAvailabilityFn } from "chainbreaker/plugin-sdk/memory-core-host-engine-qmd";
...
vi.mock("chainbreaker/plugin-sdk/memory-core-host-engine-qmd", () => ({
...
function createQmdCfg(agentId: string): ChainbreakerConfig {
  return {
