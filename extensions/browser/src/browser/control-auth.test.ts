...
import type { ChainbreakerConfig } from "../../test-support.js";
import { ensureBrowserControlAuth } from "./control-auth.js";

describe("ensureBrowserControlAuth", () => {
  async function expectNoAutoGeneratedAuth(cfg: ChainbreakerConfig): Promise<void> {
    const result = await ensureBrowserControlAuth({
      cfg,
      env: { CHAINBREAKER_BROWSER_AUTO_AUTH: "1" },
    });
