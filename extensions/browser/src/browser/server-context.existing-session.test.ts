...
describe("browser server-context existing-session profile", () => {
  it("routes tab operations through the Chrome MCP backend", async () => {
    ...
    vi.mocked(chromeMcp.listChromeMcpTabs)
      ...
      .mockResolvedValueOnce([
        { targetId: "7", title: "", url: "https://example.com", type: "page" },
        { targetId: "8", title: "", url: "https://chainbreaker.ai", type: "page" },
      ])
      .mockResolvedValueOnce([
        { targetId: "7", title: "", url: "https://example.com", type: "page" },
        { targetId: "8", title: "", url: "https://chainbreaker.ai", type: "page" },
    ...
    const opened = await live.openTab("https://chainbreaker.ai");
