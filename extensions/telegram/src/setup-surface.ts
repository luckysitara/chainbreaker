...
function shouldShowTelegramDmAccessWarning(cfg: ChainbreakerConfig, accountId: string): boolean {
...
function buildTelegramDmAccessWarningLines(accountId: string): string[] {
  ...
  return [
    ...
    "  " + formatCliCommand(`chainbreaker config set ${configBase}.dmPolicy "allowlist"`),
    "  " + formatCliCommand(`chainbreaker config set ${configBase}.allowFrom '["YOUR_USER_ID"]'`),
