...
import type { TelegramAccountConfig } from "chainbreaker/plugin-sdk/config-runtime";
...
type DispatchReplyWithBufferedBlockDispatcherFn =
  typeof import("chainbreaker/plugin-sdk/reply-dispatch-runtime").dispatchReplyWithBufferedBlockDispatcher;
type DispatchReplyWithBufferedBlockDispatcherResult = Awaited<
  ReturnType<DispatchReplyWithBufferedBlockDispatcherFn>
>;
type RecordInboundSessionMetaSafeFn =
  typeof import("chainbreaker/plugin-sdk/conversation-runtime").recordInboundSessionMetaSafe;
...
vi.mock("chainbreaker/plugin-sdk/plugin-runtime", () => ({
...
export function createNativeCommandsHarness(params?: {
  ...
  const telegramDeps = {
    loadConfig: vi.fn(() => params?.cfg ?? ({} as ChainbreakerConfig)),
  ...
  registerTelegramNativeCommands({
    bot,
    cfg: params?.cfg ?? ({} as ChainbreakerConfig),
