...
} from "chainbreaker/plugin-sdk/allowlist-config-edit";
import { createPairingPrefixStripper } from "chainbreaker/plugin-sdk/channel-pairing";
import { createAllowlistProviderRouteAllowlistWarningCollector } from "chainbreaker/plugin-sdk/channel-policy";
import { attachChannelToResult } from "chainbreaker/plugin-sdk/channel-send-result";
import { createChatChannelPlugin } from "chainbreaker/plugin-sdk/core";
import { createChannelDirectoryAdapter } from "chainbreaker/plugin-sdk/directory-runtime";
import {
  resolveOutboundSendDep,
  type OutboundSendDeps,
} from "chainbreaker/plugin-sdk/outbound-runtime";
import {
...
} from "chainbreaker/plugin-sdk/status-helpers";
import {
  ...
  base: {
    ...
    gateway: {
      ...
      logoutAccount: async ({ accountId, cfg }) => {
        ...
        const nextCfg = { ...cfg } as ChainbreakerConfig;
