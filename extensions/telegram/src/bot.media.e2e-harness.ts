...
import type { GetReplyOptions, MsgContext } from "chainbreaker/plugin-sdk/reply-runtime";
...
type FetchRemoteMediaFn = typeof import("chainbreaker/plugin-sdk/media-runtime").fetchRemoteMedia;
...
export const telegramBotDepsForTest: TelegramBotDeps = {
  loadConfig: (() =>
    ...
    }) as ChainbreakerConfig) as TelegramBotDeps["loadConfig"],
...
export async function mockMediaRuntimeModuleForTest(
  importOriginal: () => Promise<typeof import("chainbreaker/plugin-sdk/media-runtime")>,
) {
...
vi.mock("chainbreaker/plugin-sdk/media-runtime", mockMediaRuntimeModuleForTest);
...
vi.doMock("chainbreaker/plugin-sdk/agent-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("chainbreaker/plugin-sdk/agent-runtime")>();
  return {
    ...actual,
