...
import { resolveExecApprovalCommandDisplay } from "chainbreaker/plugin-sdk/infra-runtime";
import {
...
function isHandlerConfigured(params: { cfg: ChainbreakerConfig; accountId: string }): boolean {
  const config = resolveTelegramExecApprovalConfig({
    cfg: params.cfg,
    accountId: params.accountId,
  });
