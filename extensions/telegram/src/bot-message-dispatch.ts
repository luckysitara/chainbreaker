...
import { clearHistoryEntriesIfEnabled } from "chainbreaker/plugin-sdk/reply-history";
...
async function resolveStickerVisionSupport(cfg: ChainbreakerConfig, agentId: string) {
  try {
