...
type ResolveConfiguredBindingRouteFn =
  typeof import("chainbreaker/plugin-sdk/conversation-runtime").resolveConfiguredBindingRoute;
type EnsureConfiguredBindingRouteReadyFn =
  typeof import("chainbreaker/plugin-sdk/conversation-runtime").ensureConfiguredBindingRouteReady;
...
vi.mock("chainbreaker/plugin-sdk/command-auth", async (importOriginal) => {
...
describe("registerTelegramNativeCommands — session metadata", () => {
  ...
  beforeEach(() => {
    ...
    sessionMocks.resolveStorePath.mockClear().mockReturnValue("/tmp/chainbreaker-sessions.json");
