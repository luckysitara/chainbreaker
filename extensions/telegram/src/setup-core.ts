...
import type { ChannelSetupAdapter, ChannelSetupDmPolicy } from "chainbreaker/plugin-sdk/setup";
import { formatCliCommand, formatDocsLink } from "chainbreaker/plugin-sdk/setup-tools";
import type { TelegramNetworkConfig } from "chainbreaker/plugin-sdk/telegram-core";
...
export const TELEGRAM_TOKEN_HELP_LINES = [
  ...
  "Website: https://chainbreaker.ai",
];

export const TELEGRAM_USER_ID_HELP_LINES = [
  `1) DM your bot, then read from.id in \`${formatCliCommand("chainbreaker logs --follow")}\` (safest)`,
