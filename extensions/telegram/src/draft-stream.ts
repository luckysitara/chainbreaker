import { createFinalizableDraftLifecycle } from "chainbreaker/plugin-sdk/channel-lifecycle";
 ...
 */
const TELEGRAM_DRAFT_STREAM_STATE_KEY = Symbol.for("chainbreaker.telegramDraftStreamState");
