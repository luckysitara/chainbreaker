import type { createChannelPairingChallengeIssuer } from "chainbreaker/plugin-sdk/channel-pairing";
...
vi.mock("chainbreaker/plugin-sdk/channel-pairing", () => ({
...
vi.mock("chainbreaker/plugin-sdk/conversation-runtime", () => ({
