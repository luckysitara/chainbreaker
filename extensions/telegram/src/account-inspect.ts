import { resolveAccountWithDefaultFallback } from "chainbreaker/plugin-sdk/account-core";
import type { ChainbreakerConfig } from "chainbreaker/plugin-sdk/config-runtime";
import { coerceSecretRef } from "chainbreaker/plugin-sdk/config-runtime";
import { tryReadSecretFileSync } from "chainbreaker/plugin-sdk/core";
import { resolveDefaultSecretProviderAlias } from "chainbreaker/plugin-sdk/provider-auth";
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "chainbreaker/plugin-sdk/routing";
import {
  hasConfiguredSecretInput,
  normalizeSecretInputString,
} from "chainbreaker/plugin-sdk/secret-input";
import type { TelegramAccountConfig } from "chainbreaker/plugin-sdk/telegram-core";
import {
...
function inspectTokenValue(params: { cfg: ChainbreakerConfig; value: unknown }): {
  token: string;
