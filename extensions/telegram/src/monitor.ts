...
import { resolveAgentMaxConcurrent } from "chainbreaker/plugin-sdk/config-runtime";
...
import { waitForAbortSignal } from "chainbreaker/plugin-sdk/runtime-env";
...
export function createTelegramRunnerOptions(cfg: ChainbreakerConfig): RunOptions<unknown> {
  return {
    sink: {
