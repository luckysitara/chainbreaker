import { getExecApprovalReplyMetadata } from "chainbreaker/plugin-sdk/approval-runtime";
import { resolveApprovalApprovers } from "chainbreaker/plugin-sdk/approval-runtime";
import type { ChainbreakerConfig } from "chainbreaker/plugin-sdk/config-runtime";
import type { TelegramExecApprovalConfig } from "chainbreaker/plugin-sdk/config-runtime";
...
function isTelegramExecApprovalTargetsMode(cfg: ChainbreakerConfig): boolean {
