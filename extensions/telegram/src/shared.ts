...
import { formatAllowFromLowercase } from "chainbreaker/plugin-sdk/allow-from";
import {
  adaptScopedAccountAccessor,
  createScopedChannelConfigAdapter,
} from "chainbreaker/plugin-sdk/channel-config-helpers";
import { createChannelPluginBase } from "chainbreaker/plugin-sdk/core";
 ...
 */
function isBlockedByMultiBotGuard(cfg: ChainbreakerConfig, accountId: string): boolean {
