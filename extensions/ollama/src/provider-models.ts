import type { ModelDefinitionConfig } from "chainbreaker/plugin-sdk/provider-onboard";
import { fetchWithSsrFGuard, type SsrFPolicy } from "chainbreaker/plugin-sdk/ssrf-runtime";
import {
