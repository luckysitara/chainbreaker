...
type XaiPluginConfig = NonNullable<
  NonNullable<ChainbreakerConfig["plugins"]>["entries"]
>["xai"] extends {
  config?: infer Config;
}
  ? Config
...
function readPluginCodeExecutionConfig(cfg?: ChainbreakerConfig): CodeExecutionConfig | undefined {
    ...
    execute: async (_toolCallId: string, args: Record<string, unknown>) => {
      ...
      if (!apiKey) {
        return jsonResult({
          ...
          docs: "https://docs.chainbreaker.ai/tools/code-execution",
        });
      }
