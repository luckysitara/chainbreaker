...
>({
  ...
  resolveParams: (_cfg: ChainbreakerConfig, api) => ({
    providerId: "xai",
    api,
...
export function applyXaiProviderConfig(cfg: ChainbreakerConfig): ChainbreakerConfig {
  return xaiPresetAppliers.applyProviderConfig(cfg, "openai-responses");
}

export function applyXaiResponsesApiConfig(cfg: ChainbreakerConfig): ChainbreakerConfig {
  return xaiPresetAppliers.applyProviderConfig(cfg, "openai-responses");
}

export function applyXaiConfig(cfg: ChainbreakerConfig): ChainbreakerConfig {
