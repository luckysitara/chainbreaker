import type { ChainbreakerConfig, ProviderAuthResult } from "chainbreaker/plugin-sdk/provider-auth";
...
export function buildAnthropicCliMigrationResult(config: ChainbreakerConfig): ProviderAuthResult {
