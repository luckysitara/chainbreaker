...
export function resolveDdgRegion(config?: ChainbreakerConfig): string | undefined {
...
export function resolveDdgSafeSearch(config?: ChainbreakerConfig): DdgSafeSearch {
