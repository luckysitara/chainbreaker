...
export function applyOpencodeZenProviderConfig(cfg: ChainbreakerConfig): ChainbreakerConfig {
  return {
    ...cfg,
    agents: {
      ...cfg.agents,
...
export function applyOpencodeZenConfig(cfg: ChainbreakerConfig): ChainbreakerConfig {
