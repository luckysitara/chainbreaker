...
import type { ChainbreakerPluginApi, ChainbreakerPluginToolContext } from "../api.js";
...
describe("diffs tool", () => {
  ...
  beforeEach(async () => {
    ({ store, cleanup: cleanupRootDir } = await createDiffStoreHarness("chainbreaker-diffs-tool-"));
  });
...
function createApi(): ChainbreakerPluginApi {
  return createTestPluginApi({
    ...
    runtime: {} as ChainbreakerPluginApi["runtime"],
