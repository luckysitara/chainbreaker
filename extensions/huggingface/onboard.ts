...
export function applyHuggingfaceProviderConfig(cfg: ChainbreakerConfig): ChainbreakerConfig {
  return huggingfacePresetAppliers.applyProviderConfig(cfg);
}

export function applyHuggingfaceConfig(cfg: ChainbreakerConfig): ChainbreakerConfig {
